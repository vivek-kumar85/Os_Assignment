// Write a C code to implement Producer and consumer problem.
#include <stdio.h>
#include <stdlib.h>
...
int main()
{
    ...
    for (i = 1; i > 0; i++)
    {
        ...
        case 1:
            /*
            If the value of mutex is 1 and the buffer is not full, then we
        ...
        case 2:
            /*
            If the value of mutex is 1 and the buffer is not empty, then
